...
// to execute while the data is being retrieved. a boolean flag will be returned from the object and
// then stored here before being passed off to their respective activities/functions
interface UpdateInventoryWhenCookedCallback {
    fun onCallback(flag: Boolean)
}